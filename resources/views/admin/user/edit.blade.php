                            ...
                            <div class="row">
                               <div class="col-12">
                                   ...
                                   <div class="form-group row">
                                           <label for="driver_number" class="col-2 col-form-label">Driver Number</label>
                                           <div class="col-10">
                                               <input class="form-control" type="text" value="{{ $user->driver_num }}" name="driver_number" id="driver_number" required>
                                           </div>
                                  </div>
